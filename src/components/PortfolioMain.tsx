  ...
  return (
    <section className="flex justify-center font-Quicksand pt-16">
      <div className="w-[90%] flex sm:flex-row flex-col items-center relative">
        <div className="sm:absolute sm:left-0 sm:top-1/2 sm:transform sm:-translate-y-1/2 text-3xl sm:-rotate-90">
          <h1>Portfolio</h1>
        </div>
        <div className="sm:overflow-x-scroll w-full sm:ml-36 flex justify-center">
