  ...
  if (!id) {
    ...
    return (
      <div className="flex flex-col w-full px-12 justify-center items-center pt-12 pb-8 font-Quicksand">
        ...
        />
        <p className="md:w-[70%] w-full pt-4 md:text-xl text-lg">
          {" "}
          {project.description}{" "}
        </p>
        <div className="pt-4 flex xl:flex-row flex-col md:w-[70%] w-full items-center justify-between">
          ...
          <a href={project.link} className="md:text-xl text-lg rounded-full hover:bg-primary-blue/50 md:px-4 md:py-2 pt-8">
            Link to the project
          </a>
          <a href={project.github} className="md:text-xl text-lg rounded-full hover:bg-primary-blue/50 md:px-4 md:py-2 pt-8 pb-8">
